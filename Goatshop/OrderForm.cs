...
namespace Goatshop
{
    public partial class OrderForm : Form
    {
        ...
        public void ShowList()
        {
            ...
            if (searchTerm != null)
            {
                var ListOffSearchTerms = (from order in ListOffOrders
                                          ...
                                          (order.Customer.FirstName.IndexOf(searchTerm, StringComparison.OrdinalIgnoreCase) >= 0 || order.Customer.LastName.IndexOf(searchTerm, StringComparison.OrdinalIgnoreCase) >= 0) && checkBoxCustomer.Checked == true
                                          select order).ToList();
        ...
        public void OpenEditForm(Order order)
        {
            ...
            editOrder.FormClosed += Reload_FormClosed;
            editOrder.Show();
        }
